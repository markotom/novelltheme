...
function novell_main_sidebar() {
  ...
  if (  novell_get_current_layout() != 'col-1-full' ) :
...
function novell_secondary_sidebar() {
  ...
  if (  novell_get_current_layout() === 'col-3-middle' ||
        novell_get_current_layout() === 'col-3-right' ||
        novell_get_current_layout() === 'col-3-left'   ) :
